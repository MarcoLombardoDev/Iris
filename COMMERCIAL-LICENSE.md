...
| Ship Iris, or code derived from it, inside a **closed-source product** | **Commercial** |
...
The licence covers the Project Owner's copyright in Iris. It does not grant rights to the
...
| **OEM / Redistribution** | **€4,000 / year** | Embed it in a product you sell, or run it as a hosted service for your customers. |
| **Enterprise** | **from €9,000 / year** | Group-wide. Unlimited products and services. Written answers to procurement and legal questionnaires. |
| **Perpetual — Internal scope** | **€8,000** one-off | Internal scope, bought once. Covers the major version current at purchase. |
| **Perpetual — OEM scope** | **from €12,000** one-off | OEM scope, bought once. Covers the major version current at purchase. Priced per case. |
